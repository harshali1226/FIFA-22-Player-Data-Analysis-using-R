...
g_overallMale+geom_histogram(aes(fill= ..count..))+scale_fill_gradient(low = "blue", high = "green")+ggtitle("Distribution based on Overall Rating(Male)")

g_overallFemale <- ggplot(data = fifaFemaleS1, aes(overall))
g_overallFemale+geom_histogram(aes(fill= ..count..))+scale_fill_gradient(low = "blue", high = "green")+ggtitle("Distribution based on Overall Rating(Female)")
```

**Distribution based on Potential Rating**
```{r}
g_potentialMale <- ggplot(data = fifaMaleS1, aes(potential))
g_potentialMale+geom_histogram(aes(fill= ..count..))+scale_fill_gradient(low = "blue", high = "red")+ggtitle("Distribution based on Potential Rating(Male)")

g_potentialFemale <- ggplot(data = fifaFemaleS1, aes(potential))
g_potentialFemale+geom_histogram(aes(fill= ..count..))+scale_fill_gradient(low = "blue", high = "red")+ggtitle("Distribution based on Potential Rating(Female)")
```
...
ggplot(country, aes(x=nationality_name))+geom_bar(aes(fill=..count..))+scale_fill_gradient(low = "green", high = "blue")+ggtitle("Distribution based on Nationality of players (Top 10 Countries) for Male")
...
ggplot(countryF, aes(x=nationality_name))+geom_bar(aes(fill=..count..))+scale_fill_gradient(low = "green", high = "blue")+ggtitle("Distribution based on Nationality of players (Top 10 Countries) for Female")
```
